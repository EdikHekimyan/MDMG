...
function getBlockBefore(block) {
  block.insertAdjacentHTML('beforebegin', `<div class="user-win animate__animated animate__fadeIn"><p>Your amount</p><p>"${getGuarantWin()}"</p></div>`);//Ավելացնում ենք տարր HTML կոդում
}
